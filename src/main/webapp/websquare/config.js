export default {
  "WebSquare": {
    ...
    "engine": {
      "module": {
        "@src": "/InsWebApp/cm/js/swiper.min.js"
      }
    },
    "ModelUtil": {
      "copyChildrenNodes": {
    ...
    "languagePack": {
      ...
      "url": [
        {
          "@lang": "ko",
          "@value": "/InsWebApp/langpack/ko.js"
        },
        {
          "@lang": "en",
          "@value": "/InsWebApp/langpack/en.js"
        }
      ]
    },
    "projectCommon": {
      "module": [
        {
          "@name": "$c.data",
          "@src": "/InsWebApp/cm/gcc/data.xml"
        },
        {
          "@name": "$c.date",
          "@src": "/InsWebApp/cm/gcc/date.xml"
        },
        {
          "@name": "$c.ext",
          "@src": "/InsWebApp/cm/gcc/ext.xml"
        },
        {
          "@name": "$c.win",
          "@src": "/InsWebApp/cm/gcc/win.xml"
        },
        {
          "@name": "$c.util",
          "@src": "/InsWebApp/cm/gcc/util.xml"
        },
        {
          "@name": "$c.str",
          "@src": "/InsWebApp/cm/gcc/str.xml"
        },
        {
          "@name": "$c.sbm",
          "@src": "/InsWebApp/cm/gcc/sbm.xml"
        },
        {
          "@name": "$c.num",
          "@src": "/InsWebApp/cm/gcc/num.xml"
        },
        {
          "@name": "$c.hkey",
          "@src": "/InsWebApp/cm/gcc/hkey.xml"
        }
      ]
    },
    "xhr": {
