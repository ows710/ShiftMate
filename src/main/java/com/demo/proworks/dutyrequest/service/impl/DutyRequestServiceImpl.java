...
public class DutyRequestServiceImpl implements DutyRequestService {
	 ...
	 * 
	 * @process 1. 근무신청 정보 목록을 조회한다. 2. 조회 결과를 List<DutyRequestVo> 타입으로 리턴한다.
	...
	public List<DutyRequestVo> selectListDutyRequest(String userId) throws ElException {
		List<DutyRequestVo> list = dutyRequestDAO.selectListDutyRequest(userId);
		return list;
	}
	 ...
	 * 근무신청 정보 목록 건수를 조회한다.
	 * 
	 * @process 1. 근무신청 정보 목록 건수를 조회한다. 2. 조회 결과를 long 타입으로 리턴한다.
	 * @param dutyRequestVo 근무신청 정보 DutyRequestVo
	 ...
	 * 근무신청 정보를 상세 조회한다.
	 * 
	 * @process 1. 근무신청 정보를 상세 조회한다. 2. 조회 결과를 DutyRequestVo 타입으로 리턴한다.
	 * @param dutyRequestVo 근무신청 정보 DutyRequestVo
	 ...
	 * 근무신청 정보를 등록 처리한다.
	 * 
	 * @process 1. 근무신청 정보를 등록 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param dutyRequestVo 근무신청 정보 DutyRequestVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	 ...
	 * 근무신청 정보를 갱신 처리한다.
	 * 
	 * @process 1. 근무신청 정보를 갱신 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param dutyRequestVo 근무신청 정보 DutyRequestVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	 ...
	 * 근무신청 정보를 삭제 처리한다.
	 * 
	 * @process 1. 근무신청 정보를 삭제 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param dutyRequestVo 근무신청 정보 DutyRequestVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	...
	public List<DutyRequestVo> selectHopeDutyList(String paramDate) throws Exception {
		return dutyRequestDAO.selectListHopeDutyList(paramDate);
	}

	@Override
	public List<DutyRequestVo> selectHopeDutyListByDate(String paramDate) throws Exception {
		return dutyRequestDAO.selectHopeDutyListByDate(paramDate);
	}
}