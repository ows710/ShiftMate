...
public class ScheduleServiceImpl implements ScheduleService {
	 ...
	 * 
	 * @process 1. 스케줄 정보 목록을 조회한다. 2. 조회 결과를 List<ScheduleVo> 타입으로 리턴한다.
	 ...
	 * 스케줄 정보 목록 건수를 조회한다.
	 * 
	 * @process 1. 스케줄 정보 목록 건수를 조회한다. 2. 조회 결과를 long 타입으로 리턴한다.
	 * @param scheduleVo 스케줄 정보 ScheduleVo
	 ...
	 * 스케줄 정보를 상세 조회한다.
	 * 
	 * @process 1. 스케줄 정보를 상세 조회한다. 2. 조회 결과를 ScheduleVo 타입으로 리턴한다.
	 * @param scheduleVo 스케줄 정보 ScheduleVo
	 ...
	 * 스케줄 정보를 등록 처리한다.
	 * 
	 * @process 1. 스케줄 정보를 등록 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param scheduleVo 스케줄 정보 ScheduleVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	public int insertSchedule(ScheduleListVo scheduleListVo) throws ElException {
		int iRet = 0;

		for (ScheduleVo sch : scheduleListVo.getScheduleVoList()) {
			iRet += scheduleDAO.insertSchedule(sch);
		}
	 ...
	 * 스케줄 정보를 갱신 처리한다.
	 * 
	 * @process 1. 스케줄 정보를 갱신 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param scheduleVo 스케줄 정보 ScheduleVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	 ...
	 * 스케줄 정보를 삭제 처리한다.
	 * 
	 * @process 1. 스케줄 정보를 삭제 처리한다. 2. 처리 건수를 int 타입으로 리턴한다.
	 * @param scheduleVo 스케줄 정보 ScheduleVo
	 * @return 처리 건수 int
	 * @throws ElException
	 */
	...
	public List<ScheduleVo> selectScheduleViewByDate(ScheduleVo scheduleVo) {
		return scheduleDAO.selectScheduleViewByDate(scheduleVo);
	}
}